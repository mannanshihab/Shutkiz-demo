                    ...
                    Section::make('Order Items')->schema([
                        ...
                        ->schema([
                            ...
                            Select::make('Weight')
                                ...
                                ->afterStateUpdated(fn ($state, Set $set) => $set('unit_amount', ProductPriceRange::find($state)?->price ?? 0))
                                ->afterStateUpdated(fn ($state, Set $set) => $set('total_amount', ProductPriceRange::find($state)?->price ?? 0)),
