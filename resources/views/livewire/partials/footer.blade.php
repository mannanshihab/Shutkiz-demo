    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      <div class="col-span-full lg:col-span-3">
        ...
        <p class="mt-3 text-white text-sm md:text-base lg:text-lg dark:text-white">
          Shootkiz started its journey in April 2020 with the slogan "The Premium Taste of Dried Fish". Although the official journey is in 2020, our work behind market research and product market fit started from 2017.
        </p>
      </div>
      <!-- End Col -->
